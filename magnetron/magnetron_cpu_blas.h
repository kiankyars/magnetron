...
void MAG_BLAS_SPECIALIZATION(mag_kernel_registry_t* kernels) {
    /* Forward kernels */
    kernels->fwd[MAG_OP_NOP] = &mag_blas_nop;
    kernels->fwd[MAG_OP_CLONE] = &mag_blas_clone;
    kernels->fwd[MAG_OP_VIEW] = &mag_blas_nop;
    kernels->fwd[MAG_OP_TRANSPOSE] = &mag_blas_nop;
    kernels->fwd[MAG_OP_PERMUTE] = &mag_blas_nop;
    kernels->fwd[MAG_OP_MEAN] = &mag_blas_mean_f32;
    kernels->fwd[MAG_OP_MIN] = &mag_blas_min_f32;
    kernels->fwd[MAG_OP_MAX] = &mag_blas_max_f32;
    kernels->fwd[MAG_OP_SUM] = &mag_blas_sum_f32;
    kernels->fwd[MAG_OP_ABS] = &mag_blas_abs_f32;
    kernels->fwd[MAG_OP_NEG] = &mag_blas_neg_f32;
    kernels->fwd[MAG_OP_LOG] = &mag_blas_log_f32;
    kernels->fwd[MAG_OP_SQR] = &mag_blas_sqr_f32;
    kernels->fwd[MAG_OP_SQRT] = &mag_blas_sqrt_f32;
    kernels->fwd[MAG_OP_SIN] = &mag_blas_sin_f32;
    kernels->fwd[MAG_OP_COS] = &mag_blas_cos_f32;
    kernels->fwd[MAG_OP_STEP] = &mag_blas_step_f32;
    kernels->fwd[MAG_OP_SOFTMAX] = &mag_blas_softmax_f32;
    kernels->fwd[MAG_OP_SOFTMAX_DV] = &mag_blas_softmax_dv_f32;
    kernels->fwd[MAG_OP_SIGMOID] = &mag_blas_sigmoid_f32;
    kernels->fwd[MAG_OP_SIGMOID_DV] = &mag_blas_sigmoid_dv_f32;
    kernels->fwd[MAG_OP_HARD_SIGMOID] = &mag_blas_hard_sigmoid_f32;
    kernels->fwd[MAG_OP_SILU] = &mag_blas_silu_f32;
    kernels->fwd[MAG_OP_SILU_DV] = &mag_blas_silu_dv_f32;
    kernels->fwd[MAG_OP_TANH] = &mag_blas_tanh_f32;
    kernels->fwd[MAG_OP_TANH_DV] = &mag_blas_tanh_dv_f32;
    kernels->fwd[MAG_OP_RELU] = &mag_blas_relu_f32;
    kernels->fwd[MAG_OP_RELU_DV] = &mag_blas_relu_dv_f32;
    kernels->fwd[MAG_OP_GELU] = &mag_blas_gelu_f32;
    kernels->fwd[MAG_OP_GELU_DV] = &mag_blas_gelu_dv_f32;
    kernels->fwd[MAG_OP_ADD] = &mag_blas_add_f32;
    kernels->fwd[MAG_OP_SUB] = &mag_blas_sub_f32;
    kernels->fwd[MAG_OP_MUL] = &mag_blas_mul_f32;
    kernels->fwd[MAG_OP_DIV] = &mag_blas_div_f32;
    kernels->fwd[MAG_OP_ADDS] = &mag_blas_adds_f32;
    kernels->fwd[MAG_OP_SUBS] = &mag_blas_subs_f32;
    kernels->fwd[MAG_OP_MULS] = &mag_blas_muls_f32;
    kernels->fwd[MAG_OP_DIVS] = &mag_blas_divs_f32;
    kernels->fwd[MAG_OP_MATMUL] = &mag_blas_matmul_f32;

    /* Backward kernels */
    kernels->bwd[MAG_OP_NOP] = &mag_blas_nop;
    kernels->bwd[MAG_OP_CLONE] = &mag_blas_clone;
    kernels->bwd[MAG_OP_VIEW] = &mag_blas_nop;
    kernels->bwd[MAG_OP_TRANSPOSE] = &mag_blas_nop;
    kernels->bwd[MAG_OP_PERMUTE] = &mag_blas_nop;
    kernels->bwd[MAG_OP_MEAN] = &mag_blas_mean_f32;
    kernels->bwd[MAG_OP_MIN] = &mag_blas_min_f32;
    kernels->bwd[MAG_OP_MAX] = &mag_blas_max_f32;
    kernels->bwd[MAG_OP_SUM] = &mag_blas_sum_f32;
    kernels->bwd[MAG_OP_ABS] = &mag_blas_abs_f32;
    kernels->bwd[MAG_OP_NEG] = &mag_blas_neg_f32;
    kernels->bwd[MAG_OP_LOG] = &mag_blas_log_f32;
    kernels->bwd[MAG_OP_SQR] = &mag_blas_sqr_f32;
    kernels->bwd[MAG_OP_SQRT] = &mag_blas_sqrt_f32;
    kernels->bwd[MAG_OP_SIN] = &mag_blas_sin_f32;
    kernels->bwd[MAG_OP_COS] = &mag_blas_cos_f32;
    kernels->bwd[MAG_OP_STEP] = &mag_blas_step_f32;
    kernels->bwd[MAG_OP_SOFTMAX] = &mag_blas_softmax_f32;
    kernels->bwd[MAG_OP_SOFTMAX_DV] = &mag_blas_softmax_dv_f32;
    kernels->bwd[MAG_OP_SIGMOID] = &mag_blas_sigmoid_f32;
    kernels->bwd[MAG_OP_SIGMOID_DV] = &mag_blas_sigmoid_dv_f32;
    kernels->bwd[MAG_OP_HARD_SIGMOID] = &mag_blas_hard_sigmoid_f32;
    kernels->bwd[MAG_OP_SILU] = &mag_blas_silu_f32;
    kernels->bwd[MAG_OP_SILU_DV] = &mag_blas_silu_dv_f32;
    kernels->bwd[MAG_OP_TANH] = &mag_blas_tanh_f32;
    kernels->bwd[MAG_OP_TANH_DV] = &mag_blas_tanh_dv_f32;
    kernels->bwd[MAG_OP_RELU] = &mag_blas_relu_f32;
    kernels->bwd[MAG_OP_RELU_DV] = &mag_blas_relu_dv_f32;
    kernels->bwd[MAG_OP_GELU] = &mag_blas_gelu_f32;
    kernels->bwd[MAG_OP_GELU_DV] = &mag_blas_gelu_dv_f32;
    kernels->bwd[MAG_OP_ADD] = &mag_blas_add_f32;
    kernels->bwd[MAG_OP_SUB] = &mag_blas_sub_f32;
    kernels->bwd[MAG_OP_MUL] = &mag_blas_mul_f32;
    kernels->bwd[MAG_OP_DIV] = &mag_blas_div_f32;
    kernels->bwd[MAG_OP_ADDS] = &mag_blas_adds_f32;
    kernels->bwd[MAG_OP_SUBS] = &mag_blas_subs_f32;
    kernels->bwd[MAG_OP_MULS] = &mag_blas_muls_f32;
    kernels->bwd[MAG_OP_DIVS] = &mag_blas_divs_f32;
    kernels->bwd[MAG_OP_MATMUL] = &mag_blas_matmul_f32;
}
